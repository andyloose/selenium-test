...
class TestPimPageHrm:
    ...
    def test_pim_page_valid_user_hrm(self):
        ...
        pim_page.type_employee_name("Paul Collings")
        time.sleep(2)
        pim_page.click_button_search()
        time.sleep(2)
        assert pim_page.get_message_record_found() == "(1) Record Found", "(1) Record Found message not found"
        time.sleep(2)